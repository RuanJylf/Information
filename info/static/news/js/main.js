...
function generateImageCode() {
    // 需求：发出对后端要取验证码的请求。/imageCode?imageCodeId=xxxx
    // 1、先生成一个唯一标识的参数uuid作为imageCodeId
    imageCodeId = generateUUID()
    // 2、发送请求需要url，需要拼接一个url
    var url = "/passport/imageCode?imageCodeId=" + imageCodeId
    // 3、因为请求是在img标签中自动发起，所以我们需要修改img标签的src属性
